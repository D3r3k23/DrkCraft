...
namespace DrkCraft
{
    ...
    public:
        ...
        void upload_uniform_int2(const std::string& name, const glm::ivec2& data);
        void upload_uniform_int3(const std::string& name, const glm::ivec3& data);
        void upload_uniform_int4(const std::string& name, const glm::ivec4& data);
        ...
        void upload_uniform_uint2(const std::string& name, const glm::uvec2& data);
        void upload_uniform_uint3(const std::string& name, const glm::uvec3& data);
        void upload_uniform_uint4(const std::string& name, const glm::uvec4& data);
        ...
        void upload_uniform_float2(const std::string& name, const glm::vec2& data);
        void upload_uniform_float3(const std::string& name, const glm::vec3& data);
        void upload_uniform_float4(const std::string& name, const glm::vec4& data);
